...
def SCORE(score):
    ...
    with open('SCORE_RECORDS_HM.txt') as s:
        ...
        records.write(' incorrect guesses ')
...
# game variables
hangman_status = 0
fruits = ["STRAWBERRY","PEAR","APPLE","ORANGE","BANANA","BLUEBERRY"] #one level of words
gadgets = ["PHONE","LAPTOP","DESKTOP","MONITOR","COMPUTER","HEADPHONES"] #another level of words
clothes = ["SHIRT","PANTS","SHOES","SOCKS","JACKET","SHORTS","HAT"]
# words = list(level)
words = fruits
